...
void registerMinorTests() {
  ...
  group('Approvals: test of other minor things |', () {
    ...
    test('Verify string with not correct DiffInfo.', () async {
      ...
      final existentApprovedPath = File.fromUri(
        approvalDirectory.uri.resolve('invalid_diff.approved.txt'),
      ).path;
      final existentReceivedPath = File.fromUri(
        approvalDirectory.uri.resolve('invalid_diff.received.txt'),
      ).path;
