...
/// Mock `NoPlatformWrapper` is a class for platform detection.
/// It is used to detect if the current platform is not `Windows`, `Linux`, or `MacOS`.
class NoPlatformWrapper implements PlatformWrapper {
  const NoPlatformWrapper();
